    ...
    return (
      <div className="card  margin" >
        ...
        <div className="card-detail">
          <div>
            <div className="cartFont">{this.props.quoteName} - <span style={{ marginTop: '0px', fontSize: '20px' }}>{this.context.intl.formatMessage({ ...messages.configureProducts })}</span></div>
          </div>
        </div>
      </div>
    );
